...
import { Map, FileText, AlertTriangle, ChevronRight, ShieldAlert, X, Loader2, Users } from "lucide-react";
...
const CommandCenter = () => {
  ...
  const loadPendingEmergencies = async () => {
    ...
    try {
      const pendingQuery = query(collection(db, "emergencies"), where("status", "==", "pending"));
